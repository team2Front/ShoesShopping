...
<body>
	...
	<div id="adminBanner" class="d-flex align-items-center">
		<div class="adminLogo">
			<a href="/shopping/admin/HomeController"><img
				src="../resources/images/sashoes_logo.png" /></a>
		</div>
			...
			<form id="pnameForm" name="pnameForm" action="#" onsubmit="handleCheckData()" novalidate>
				...
				<div class="cbtn-group btn-group" data-toggle="buttons" style="width: 800px;">
					...
					<div class="form-check">
						...
						<input type="checkbox" autocomplete="off"> 
						<i class="fa fa-check"></i>
						</label> <label class="cbtn btn btn-secondary" style="width: 75px; height: 40px;"> 240 
						<input type="checkbox" autocomplete="off"> 
						<i class="fa fa-check"></i>
						</label> 
						...
						<input type="checkbox" autocomplete="off"> 
						<i class="fa fa-check"></i>
						</label> <label class="cbtn btn btn-secondary" style="width: 75px; height: 40px;"> 260 
						<input type="checkbox" autocomplete="off"> 
						<i class="fa fa-check"></i>
						</label> 
				...
				<div class="custom-file">
					<label class="custom-file-label" for="battach1">상품 사진1</label> 
					<input class="custom-file-input" type="file" class="form-control" id="battach1" name="battach1"> 
					
					<label class="custom-file-label" for="battach2">상품 사진2</label> 
					<input class="custom-file-input" type="file" class="form-control" id="battach2" name="battach2"> 
					
					<label class="custom-file-label" for="battach3">상품 사진3</label> 
					<input class="custom-file-input" type="file" class="form-control" id="battach3" name="battach3"> 
					
					<label class="custom-file-label" for="battach4">상품 사진4</label> 
					<input class="custom-file-input" type="file" class="form-control" id="battach4" name="battach4"> 
					
					<label class="custom-file-label" for="battach5">상품 사진5</label> 
					<input class="custom-file-input" type="file" class="form-control" id="battach5" name="battach5"> 
				</div>
